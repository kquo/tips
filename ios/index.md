...
Compile sample app [Textor](https://github.com/USERNAME/textor), an **iOS** text editor application, on **macOS**. Should use a different open-source app since this one is no longer maintained.
...
2. Checkout the code: `git clone https://github.com/USERNAME/textor`
