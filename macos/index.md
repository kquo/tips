...
```
sudo dscl . append /Users/someuser AuthenticationAuthority ";AppleID;user@example.com"
```
...
See <https://github.com/USERNAME/homebrew-tools>
...
```
  My tap repo    = <https://github.com/USERNAME/homebrew-tools>
  My tap name    = `USERNAME/tools`
  Sample install = `brew install USERNAME/tools/awslogin`
```
...
```
  class Awsinfo < Formula
    ...
    homepage "https://github.com/USERNAME/awsinfo"
    url "https://github.com/USERNAME/awsinfo/releases/download/2.0.11/awsinfo-2.0.11.tar.gz"
...
- Voila! Now users can install your app easily with: `brew install USERNAME/tools/awsinfo`
