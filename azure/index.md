...
The _resource_ and _security_ services breakdown provided below does not necessarily align with Microsoft's own documentation. Nonetheless, this tip offers a better initial approach into understanding the architecture of the Microsoft Azure cloud, offering a more helpful perspective on how its components integrate. In essence, the Azure cloud can be summarized by its two fundamental realms: Azure Resource Services and Azure Security Services.
